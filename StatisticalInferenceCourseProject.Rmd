...
rexp(n=10, rate=0.2)
```
produces 10 exponentially-distributed numbers with rate ($\lambda$) of 0.2. Shown below is an example of a histogram showing data from an exponential distribution with n = 1000 and $\lambda$ = 0.2.  
...
The simulation is done with these steps:
...
2.  Also, the actual mean of the sample means and the actual variance of the sample means are respectively a good approximation of values predicted by the central limit theorem. This is verified by R code.
